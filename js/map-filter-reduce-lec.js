...
// .inclues always retruns a boolean
...
let prodPrice = products.filter(product => product.price < 50);

console.log("Items under $50: ", prodPrice)
...
let reducedPrice = products.reduce((previousValue, currentValue) => {
    console.log(previousValue)
    console.log(currentValue)
    if(currentValue.price < 50) {
